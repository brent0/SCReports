---
title: "Science / Industry Meeting"
...
CFA-24
```{r figure.catch9, out.width="85%", fig.align="center"}
...
```{r figure.sur3, out.width="155%", fig.align="center"}
knitr::include_graphics(file.path(wd3, "SurveyStationsNone.pdf"))
```

--- 

```{r figure.sur4, out.width="155%", fig.align="center"}
...
### Survey Timing 
```{r figure.tim1, out.width="100%", fig.align="top"}
...
### Survey Timing 
```{r figure.tim2, out.width="100%", fig.align="top"}
...
knitr::include_graphics(file.path("D:", "bio.data", "bio.snowcrab", "output", "maps", "survey", "snowcrab", "annual", "bycatch", "ms.mass.2211", paste("ms.mass.2211.", year-2, ".png", sep = "")))
```
...
::: block
-   New log books. You can use either for the upcoming season but expect that the new ones will be required for the 2023 seasons.
...
-   Industry Meetings  
             &nbsp;&nbsp; Jan 28th (presentation sent after meeting)  
...
-   Industry Meeting (SAR Presentation)  
             &nbsp;&nbsp; Feb 25th(tentative) - Presentation of the SAR
        
-   AC TAC call/meeting  
             &nbsp;&nbsp; Sometime after industry has had a chance to review the  
             &nbsp;&nbsp; presentation and/or draft SAR if available 
    
-   Trying to get David Brickman in at some point to present temperature     
:::
