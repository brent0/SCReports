...
### Landings 
For official report please refer to: https://inter-j01.dfo-mpo.gc.ca/mqr/quotareports
...
```{r figure 1, out.width="90%", fig.align="center", fig.pos = "t"}
...
### Annual Catch Rates
```{r figure 4, out.width="65%", fig.align="center", fig.pos = "t"}
...
### Weekly CPUE
```{r figure 5, out.width="93%", fig.align="center"}
...
```{r figure 10, out.width="90%", fig.align="center"}
...
<!-- knitr::include_graphics(file.path(wd, "N-ENS_Spring_size_freq.pdf")) -->
<!-- ``` -->
<!-- ::: -->

<!-- ::: column -->
<!-- ```{r figure 17, out.width="105%", fig.align="center"} -->
<!-- knitr::include_graphics(file.path(wd, "N-ENS_Summer_size_freq.pdf")) -->
<!-- ``` -->
<!-- ::: -->
<!-- ::: -->
<!-- --- -->
...
```{r figure 20, out.width="90%", fig.align="center"}
...
::: columns
::: column
```{r figure 38, out.width="95%", fig.align="center"}
